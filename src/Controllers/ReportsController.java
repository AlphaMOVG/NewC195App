...
public class ReportsController {
    ...
    public void initialize() throws SQLException {
        ...
        ObservableList<Contacts> contactsObservableList = ContactDBA.getAllContacts();
    ...
    public void appointmentDataByContact() {
        try {
            ...
            ObservableList<Appointments> getAllAppointmentData = AppointmentDBA.getAllAppointments();
            ObservableList<Appointments> appointmentInfo = FXCollections.observableArrayList();
            ObservableList<Contacts> getAllContacts = ContactDBA.getAllContacts();
    ...
    public void customerByCountry() throws SQLException {
        try {
            ...
            ObservableList<Reports> aggregatedCountries = ReportsDBA.getCountries();
